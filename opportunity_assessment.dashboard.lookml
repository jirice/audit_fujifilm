- dashboard: Opportunity Assessment
  ...
  - name: 80/20 Suppliers
    ...
    explore: data
    type: table
    fields: [data.supplier_parent_name, data.total_spend, data.total_spend_running_total,
    ...
    conditional_formatting: [{type: between, value: ['0', '0.801'], background_color: "#2fa02b",
        font_color: !!null '', palette: {name: Red to Yellow to Green, colors: ["#F36254",
          ...
          _LINE_NUM: 184}, bold: false, italic: false, strikethrough: false, _FILE: fujifilm_audit/opportunity_assessment.dashboard.lookml,
        __LINE_NUM: 177}]
    row: 15
    col: 0
    width: 12
